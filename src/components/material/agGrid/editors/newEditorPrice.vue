<template lang="pug">
input.ag_input_edit(:ref='"input"' @keydown='onKeyDown($event)' type='number' v-model='value')
</template>
...
.ag_input_edit::selection {
  color: white;
  background: #0057ad;
}

input.ag_input_edit::-webkit-outer-spin-button,
input.ag_input_edit::-webkit-inner-spin-button {
