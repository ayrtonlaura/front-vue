<script>
export default { name: 'comex-tracking-contenedores' }
</script>
<script setup>
...
const columnDefs = [
  ...
  { headerName: 'CODPRO', field: 'marca', width: 140 },
  { headerName: 'PRODUCTO', flex: 1 },
  { headerName: 'INVOICE', width: 120 },
  { headerName: 'PENDIENTE', width: 130 },
  { headerName: 'ASIGNAR', width: 120 }
]
    ...
    v-row 
      ...
      v-col(cols="9") 
        ...
        v-row.mb-2(dense align="center") 
          v-col 
            p.text-primary.font-weight-bold.text-h4 Contenedores   
